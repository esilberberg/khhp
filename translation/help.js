document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateContentLanguage(language) {
        ...
        accordionButtons.forEach((button, index) => {
            button.textContent = translations[language][`button-${index + 1}`]; // Assuming buttons have IDs like accordion-button-1 etc. 
            accordionPanels[index].textContent = translations[language][`panel-${index + 1}`]; // Assuming panels have IDs like accordion-panel-1 etc. 
          });
    }
